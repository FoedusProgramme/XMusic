...
public class MainActivity extends BaseActivity implements ServiceCallback, PlaybackControlListener {
    ...
    public void setupControllerListener() {
        mediaController.addListener(new Player.Listener() {
            ...
            public void onMediaItemTransition(@Nullable MediaItem mediaItem, int reason) {   
                if (mediaController.getPlaybackState() == Player.STATE_BUFFERING || mediaController.getPlaybackState() == Player.STATE_READY) {
    ...
    private void updateSongInfoLayout(int pos) {
		...
		final String mime;
		try {
            mime = XUtils.getAudioCodec(this, Uri.parse("file://"+RuntimeData.songs.get(index).path));
