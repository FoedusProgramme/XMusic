...
public class AboutFragment extends SubFragment {
    ...
    private final String WEBSITE_LINK = "https://foedusprogramme.github.io/XMusic/";
    ...
    private void setupListeners() {
        ...
        binding.seventhItem.setOnClickListener(v -> openLink(WEBSITE_LINK));
        binding.extraItem.setOnClickListener(v -> openFragment(new ContributionsFragment()));
    }
